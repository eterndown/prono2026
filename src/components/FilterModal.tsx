...
const FilterModal: React.FC<FilterModalProps> = ({
  ...
  const [openSection, setOpenSection] = useState<"etapa" | "equipo" | null>(
    "etapa"
  );
      ...
      <div className="relative bg-zinc-950 text-white w-full sm:max-w-xl h-[95vh] sm:h-[85vh] flex flex-col rounded-t-[3rem] sm:rounded-[3rem] shadow-[0_0_100px_rgba(0,0,0,0.8)] border border-zinc-800 overflow-hidden animate-in slide-in-from-bottom-20 duration-500">
          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-[10px] font-bold text-zinc-500 uppercase tracking-widest mt-1">
                Personaliza tu vista de partidos
              </p>
            </div>
          </div>
          <button
        ...
        <div className="flex-1 overflow-y-auto scrollbar-hide px-6 py-4">
          ...
          <div className="mb-4">
            <button
              onClick={() =>
                setOpenSection(openSection === "etapa" ? null : "etapa")
              }
              className={`w-full p-6 flex justify-between items-center rounded-3xl transition-all duration-300 ${
                openSection === "etapa"
          ...
          <div className="mb-4">
            <button
              onClick={() =>
                setOpenSection(openSection === "equipo" ? null : "equipo")
              }
              className={`w-full p-6 flex justify-between items-center rounded-3xl transition-all duration-300 ${
                openSection === "equipo"
                  ? "bg-zinc-900 border border-zinc-800"
            ...
            {openSection === "equipo" && (
              <div className="px-4 py-6 grid grid-cols-1 gap-2 animate-in slide-in-from-top-4 fade-in duration-300">
                ...
                {sortedEquipos.map((e) => (
                  ...
                  >
                    <div className="flex items-center gap-4">
                      <span className="text-3xl filter saturate-150">
                        {e.bandera}
                      </span>
