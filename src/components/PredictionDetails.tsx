...
export const PredictionDetails: React.FC<PredictionDetailsProps> = ({
  ...
  const awayName =
    visitorTeam?.nombre || match.placeholderVisitante || "Visitante";
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="flex flex-col gap-6">
          <div className="bg-zinc-900/50 p-6 rounded-2xl border border-zinc-800 flex-1 flex flex-col items-center justify-center">
            <span className="text-xs text-zinc-500 uppercase font-bold mb-2">
              Marcador Sugerido
            </span>
            <span className="text-5xl font-black text-emerald-400 tracking-tighter">
              {prediction.suggestedScore}
            </span>
            ...
            <span className="text-[10px] text-zinc-500 mt-2 uppercase">
              Confianza de IA: {(prediction.confidence * 100).toFixed(0)}%
            </span>
          </div>
