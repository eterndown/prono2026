      ...
      <div className="p-5 space-y-5">
        <div className="flex justify-between items-start">
          <div className="space-y-1">
            <h4 className="text-[11px] font-black uppercase text-emerald-500 tracking-tighter leading-none group-hover:text-emerald-400 transition-colors">
              {estadio.e}
            </h4>
        ...
        <div className="space-y-2">
          <span className="text-[7px] font-black text-zinc-700 uppercase tracking-[0.3em] px-1">
            Geolocalización GPS
          </span>
          <div className="grid grid-cols-2 gap-3">
