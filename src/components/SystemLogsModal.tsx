          ...
          {logs.length === 0 ? (
            ...
            logs
              .map((log, i) => (
                <div
                  key={i}
                  className="p-3 bg-zinc-900/50 border border-zinc-800 rounded-xl flex gap-4 items-start group hover:border-zinc-700 transition-colors"
                >
                  ...
                  <div className="space-y-1 overflow-hidden flex-1">
                    <div className="flex items-center gap-2 text-[8px] text-zinc-600">
                      ...
                      <span className="tabular-nums">
                        {formatMilitar(log.timestamp)}
                      </span>
                      <span
                        className={`px-1 rounded uppercase font-black tracking-widest ${
                          log.level === "error"
