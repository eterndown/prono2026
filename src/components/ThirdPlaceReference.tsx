...
const ThirdPlaceReference: React.FC<{
  isOpen: boolean;
  onClose: () => void;
}> = ({ isOpen, onClose }) => {
      ...
      <div className="bg-zinc-900 border border-zinc-800 w-full max-w-5xl max-h-[92vh] overflow-y-auto rounded-[2.5rem] shadow-[0_0_50px_rgba(0,0,0,0.5)] flex flex-col scrollbar-hide">
        ...
        <div className="sticky top-0 bg-zinc-900/95 backdrop-blur-md px-6 sm:px-10 py-8 border-b border-zinc-800 flex justify-between items-center z-20">
          <div className="flex items-center gap-5">
            ...
            <div>
              <h2 className="text-2xl sm:text-3xl font-black uppercase italic tracking-tighter leading-none text-white">
                Matriz de Clasificación
              </h2>
              <p className="text-[10px] font-black text-zinc-500 uppercase tracking-[0.3em] mt-2">
                Documento Técnico • Motor de Pronóstico Mundial 2026
              </p>
            </div>
          </div>
          <button
        ...
        <div className="p-6 sm:p-10 space-y-12">
          ...
          <section className="grid grid-cols-1 lg:grid-cols-3 gap-10">
            <div className="lg:col-span-2 space-y-6">
              <div className="flex items-center gap-3 text-emerald-400">
                ...
                <h3 className="font-black uppercase text-base tracking-widest italic">
                  Análisis Combinatorio del Formato
                </h3>
              </div>
              <p className="text-sm text-zinc-400 leading-relaxed font-medium">
                Con la expansión a{" "}
                <span className="text-white font-bold">12 grupos (A-L)</span>,
                el sistema de avance se vuelve dinámico. Clasifican los dos
                primeros de cada grupo (24 equipos), y los{" "}
                <span className="text-emerald-500 font-bold italic">
                  8 cupos restantes
                </span>{" "}
                se otorgan a los mejores terceros lugares tras comparar sus
                registros.
              </p>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="p-6 bg-zinc-950 rounded-[2rem] border border-zinc-800 flex flex-col justify-center items-center text-center space-y-2 group hover:border-emerald-500/30 transition-all">
                  <span className="text-4xl font-black italic text-emerald-500 tracking-tighter group-hover:scale-110 transition-transform">
                    495
                  </span>
                ...
                <div className="p-6 bg-zinc-950 rounded-[2rem] border border-zinc-800 border-l-4 border-l-emerald-500">
                  <p className="text-[11px] text-zinc-400 italic leading-relaxed">
                    ...
                    . El simulador calcula en milisegundos cuál de estas
                    combinaciones se ha activado para asignar los cruces de
                    Dieciseisavos sin errores."
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-zinc-800/20 p-8 rounded-[2.5rem] border border-zinc-800 space-y-6 shadow-xl shadow-black/20">
              <h4 className="text-white font-black uppercase text-xs tracking-widest flex items-center gap-3">
                <Award className="w-5 h-5 text-emerald-500" /> Criterios de
                Ranking
              </h4>
              <div className="space-y-4">
                {[
                  { label: "Puntos", desc: "Suma total en fase grupos" },
                  {
                    ...
                    desc: "Goles Favor - Goles Contra",
                  },
                  {
                    label: "Goles Marcados",
                    desc: "Total anotados en 3 partidos",
                  },
                  {
                    label: "Partidos Ganados",
                    desc: "Número total de victorias",
                  },
                ].map((item, i) => (
                  <div
                    key={i}
                    className="flex flex-col gap-1 border-b border-zinc-800/50 pb-3"
                  >
                    <div className="flex items-center justify-between">
                      <span className="text-zinc-300 font-black text-[10px] uppercase tracking-tighter">
                        {item.label}
                      </span>
          ...
          <section className="space-y-8">
            <div className="flex flex-col gap-2">
              <h3 className="text-white font-black uppercase text-sm tracking-widest italic flex items-center gap-3">
                <Layers className="w-6 h-6 text-emerald-500" /> Tabla de
                Asignación de Llaves (M73 - M87)
              </h3>
              <p className="text-zinc-500 text-[10px] font-bold uppercase tracking-widest pl-9">
                Mapeo dinámico de mejores terceros a posiciones de playoff
              </p>
            </div>
              ...
              <table className="w-full text-left border-collapse">
                <thead>
                  <tr className="bg-zinc-900/50">
                    <th className="p-6 text-[10px] font-black uppercase text-zinc-500 tracking-widest border-b border-zinc-800">
                      Partido ID
                    </th>
                    <th className="p-6 text-[10px] font-black uppercase text-zinc-500 tracking-widest border-b border-zinc-800">
                      Local (Inamovible)
                    ...
                    <th className="p-6 text-[10px] font-black uppercase text-zinc-500 tracking-widest border-b border-zinc-800">
                      Visitante (Slot Variable de 3°)
                    </th>
                    <th className="p-6 text-[10px] font-black uppercase text-zinc-500 tracking-widest border-b border-zinc-800 text-center">
                      Ruta Técnica
                    </th>
                  </tr>
                </thead>
                <tbody className="text-xs divide-y divide-zinc-900">
                  {[
                    ...
                    >
                      ...
                      <td className="p-6 font-black text-white uppercase text-[11px] tracking-tight">
                        {row.loc}
                      </td>
                      <td className="p-6">
            ...
            <div className="flex items-center gap-3 px-6 py-4 bg-zinc-900/30 rounded-2xl border border-zinc-800 border-dashed">
              ...
              <p className="text-[10px] text-zinc-500 font-bold uppercase tracking-[0.1em] italic">
                Sistema de Asignación Automática: Las llaves restantes se
                completan con los 2dos lugares de los grupos A-L.
              </p>
            </div>
          </section>
          ...
          <section className="bg-gradient-to-br from-zinc-950 to-zinc-900 p-10 rounded-[3rem] border border-zinc-800 shadow-2xl relative overflow-hidden group">
            ...
            <h3 className="text-white font-black uppercase text-sm tracking-widest italic mb-10 flex items-center gap-3">
              <Trophy className="w-6 h-6 text-emerald-500" /> Flujo Evolutivo de
              Eliminación
            </h3>
              ...
              {[
                {
                  label: "Dieciseisavos",
                  teams: "32 Equipos",
                  desc: "Top 2 + 8 Mejores 3ros",
                },
                {
                  label: "Octavos",
                  teams: "16 Equipos",
                  desc: "Enfrentamientos Directos",
                },
                {
                  label: "Cuartos",
                  teams: "8 Equipos",
                  desc: "Rumbo a Semifinales",
                },
                {
                  label: "Semifinales",
                  teams: "4 Equipos",
                  desc: "La Antesala del Título",
                },
              ].map((step, i) => (
